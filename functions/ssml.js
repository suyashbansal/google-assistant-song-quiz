...
const SSML = class {
  ...
  // Audio tag
  audio (url, description, clipBegin, clipEnd) {
    ...
    if (url) {
      if (description && clipBegin && clipEnd) {
        this.tags.push(`<audio src='${url}' clipBegin='${clipBegin}' clipEnd='${clipEnd}'><sub alias='${this.escape(description)} sound'>&#x1f50a;</sub></audio>`);
      } else if (description) {
